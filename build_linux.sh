...
cd ../
g++ -o ../bin/oberonc  main.cpp oberonc/*.cpp global/*.cpp debugger/*.cpp debugger/debugger_implementations/*.cpp scanner/*.cpp parser/*.cpp  symbol_table/*.cpp symbol_table/identifier_category/*.cpp ast/*.cpp ast/declaration/*.cpp ast/expression/*.cpp ast/statement/*.cpp  -lfl
